                    ...
                    <form action="/insertArticle" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="input" class="form-control" name="title" aria-describedby="Donnez un titre à votre article" placeholder="Donnez un titre à votre article">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="content" rows="3" placeholder="Ecrivez le contenu de votre article"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Image</label>
                                <input type="input" class="form-control" name="image" aria-describedby="l'image illustrera votre article" placeholder="">
                                <!-- <input type="input" class="form-control" name="image" aria-describedby="l'image illustrera votre article" placeholder="l'image illustrera votre article"> -->
                            </div>
